...
export default function PipelineItem({script,handleDownload, index}) {
    ...
    return (
        <Box sx={{ display: 'flex', padding: '5px 25px 5px 25px', backgroundColor: '#c5e2ee', borderRadius: '5px', marginBottom:'5px', alignItems:"center", border: "1px solid black", justifyContent:"space-between" }}>
