...
namespace StackUnderFlow.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240611113619_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StackUnderFlow.Domains.Model.Follow", b =>
                {
            ...
            modelBuilder.Entity("StackUnderFlow.Domains.Model.FriendRequest", b =>
                {
                    b.Property<int>("UserId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StackUnderFlow.Domains.Model.GroupRequest", b =>
                {
                    b.Property<int>("GroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StackUnderFlow.Domains.Model.Follow", b =>
                {
                    b.HasOne("StackUnderFlow.Domains.Model.User", "User2")
                        .WithMany("Followed")
                        .HasForeignKey("UserId1")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("StackUnderFlow.Domains.Model.User", "User1")
                        .WithMany("Follower")
            ...
            modelBuilder.Entity("StackUnderFlow.Domains.Model.GroupRequest", b =>
                {
                    b.HasOne("StackUnderFlow.Domains.Model.Group", "Group")
