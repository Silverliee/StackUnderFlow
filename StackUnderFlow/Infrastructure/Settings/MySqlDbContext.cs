...
public class MySqlDbContext(IConfiguration configuration) : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FriendRequest>().HasKey(f => new { f.UserId1, f.UserId2 });
        modelBuilder
        ...
        modelBuilder.Entity<GroupRequest>().HasKey(gr => new { gr.GroupId, gr.UserId });
        ...
        modelBuilder.Entity<Sharing>().HasKey(sh => new { sh.ScritpId, sh.UserId });
        modelBuilder
            .Entity<Sharing>()
            .HasOne(sh => sh.Script)
        ...
        modelBuilder.Entity<Status>().HasKey(st => st.StatusId);
        ...
        modelBuilder.Entity<Group>().Property(g => g.GroupName).HasMaxLength(100).IsRequired();

        modelBuilder.Entity<Script>().Property(s => s.ScriptName).HasMaxLength(100).IsRequired();
        modelBuilder.Entity<Script>().Property(s => s.Description).HasMaxLength(1000);
